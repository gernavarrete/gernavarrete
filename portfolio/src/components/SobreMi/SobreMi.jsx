...
export default function SobreMi() {
  return (
    <div className="main-div-sobremi">
      <div className="div-avatar-h1">
        <img className="avatar" src={Avatar} alt="German Dario Navarrete" />
        <h1 className="h1-title">Mi Background</h1>
      </div>
      <div className="div-paragraph">
        <p>
          <h2 className="h2-title">Te invito a conocerme un poco mas!</h2>
          <p>
